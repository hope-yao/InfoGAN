...
class MnistDataset64(object):
    def __init__(self):
        ...
        train_set = H5PYDataset('/home/hope-yao/Documents/Data/MNIST/Mnist64/Mnist64_400.hdf5', which_sets=('train',))
        handle = train_set.open()
        train_data = train_set.get_data(handle, slice(0, train_set.num_examples))
        train_images = train_data[0]
        train_images = train_images.reshape(train_images.shape[0], train_images.shape[2] * train_images.shape[3] )
        ...
        test_set = H5PYDataset('/home/hope-yao/Documents/Data/MNIST/Mnist64/Mnist64_400.hdf5', which_sets=('valid',))
        handle = test_set.open()
        test_data = test_set.get_data(handle, slice(0, test_set.num_examples))
        test_images = test_data[0]
        test_images = test_images.reshape(test_images.shape[0], test_images.shape[2] * test_images.shape[3] )
